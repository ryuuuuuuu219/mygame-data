...
public class ArryAceAircraft : AircraftController
{
    ...
    Vector3 manuver(Vector3 localDir)
    {
        ...
        float rollangle = Vector3.Angle(transform.up, localDir);
        ...
        result.x = Mathf.Clamp(localDir.y, -1f, 1f) * pitchStrength; // pitch
        result.y = rollError;                                       // roll
        result.z = rollError * 0.3f;                                // yaw
